...
class _ReservationViewState extends State<ReservationView> {
  ...
  void _addReservation() async {
    ...
    if (userDb?.role == Role.user) {
      Reservation reservation = Reservation(uID, "nie_dziala_id_usun", 401,
          DateTime(2023, 11, 19), DateTime(2023, 11, 23), "Active", true, []);
  ...
  void _showReservations(UserDb userDb) async {
    Map<String, dynamic>? getReservationFromSingleHotel =
        await _reservationServices
